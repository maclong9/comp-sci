...
Most undergraduate CS programs start with an "introduction" to computer programming. The best versions of these courses cater to both novices and also thos who missed beneficial concepts and programming models when first learning to code.

The standard recommendations for this content are _Structure and Interpretation of Computer Programs_ which is availible as a [book](https://sarabander.github.io/sicp/html/index.xhtml).
